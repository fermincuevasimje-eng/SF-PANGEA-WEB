...
# --- 1.5 CATÁLOGO MAESTRO (ACTUALIZADO CON CSV) ---
CATALOGO_MAESTRO = {
    ...
    "INDEPENDENCIA": ["REFORMA Y FERROCARRILES NACIONALES (SAN JUAN BAUTISTA)", "METEORO", "INDEPENDENCIA", "LAS TORRES (CIENTIFICOS)", "SAN SEBASTIAN"],
    "SAN SEBASTIAN": ["SAN SEBASTIAN CENTRO", "FERROCARRILEROS", "BANCARIOS", "VALLE VERDE"],
    ...
    "SAUCES": ["SAUCES I", "SAUCES II", "SAUCES III", "SAUCES IV", "SAUCES V"],
    "SANTA ANA TLAPALTITLAN": ["CENTRO", "CASCO VIEJO", "SANTIAGUITO", "EL PROGRESO", "BUENAVISTA"],
...
# Generamos el mapa inverso para que el sistema sepa cruzar los datos
