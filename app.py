...
st.set_page_config(page_title="SF PANGEA v4.6.4", layout="wide")

# Parámetros Operativos y URL de Bitácora Confirmada
...
# --- MOTOR DE PROCESAMIENTO (LÓGICA PESADA) ---
...
if not st.session_state.autenticado:
                ...
                if not df_v.empty:
                    ...
                    if st.button("💾 REGISTRAR EN BITÁCORA"):
                        try:
                            ...
                            res_json = f"Pts: {len(ordenados)}, Lums: {tl}, Postes: {tp}, Km: {round(dist_real_km,2)}"
                            ...
                            st.balloons(); st.success(f"¡Registrado por {st.session_state.usuario_nombre}!")
    ...
    with tab2:
        ...
        except: st.info("Sincronizando con BD_PANGEA...")
