                ...
                if up_c:
                    try:
                        ...
                        if not df_v.empty:
                            ...
                            # --- KML LIMPIO (Reemplaza este ciclo for) ---
                        for p in ruta_ordenada:
                            # 1. Nombre limpio: Solo el nombre del ID
                            ...
                            # 2. Iteramos columnas eliminando explícitamente lo que ya no queremos ver
                            for col in cols_orig:
                                val = str(p.get(col, '')).strip()
                                # Filtramos para que Ruta_Asignada no se imprima aquí tampoco
                                if val and col != 'Ruta_Asignada': 
