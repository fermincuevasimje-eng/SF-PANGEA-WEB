    ...
    if st.session_state.menu == "Inicio":
        ...
        with tab_admin:
            ...
            def fabricar_acta_pdf(datos_entrega, inventario_resumen, pendientes_resumen):
                ...
                # Encabezado Institucional Rígido
                pdf.set_font("Arial", 'B', 12)
            ...
            with tab_previsualizar:
                ...
                # 1. Recuperación automática del catálogo blindado en la nube
                ...
                # 2. Recuperación de oficios pendientes vivos de los módulos 4 y 5
                ...
                if not func_entrante:
                    ...
                    if st.button("📦 COMPILAR EXPEDIENTE COMPLETO DE ENTREGA-RECEPCIÓN", type="primary", use_container_width=True):
                        try:
                            ...
                            # Fabricación de entregables en memoria RAM
                            ...
                            # --- INTEGRACIÓN CON LAS CLAVES DE NOMENCLATURA OFICIAL DE CONTRALORÍA/OSFEM ---
                            with zipfile.ZipFile(zip_buffer, "w", zipfile.ZIP_DEFLATED) as zf:
                                zf.writestr("ACTA_ENTREGA_RECEPCION_DAP.pdf", pdf_acta_bytes)
                                zf.writestr("ANEXO_RM_01_INVENTARIO_ALMACEN.xlsx", excel_inventario_bytes)
                                zf.writestr("ANEXO_AT_03_ASUNTOS_EN_TRAMITE.xlsx", excel_pendientes_bytes)
                                zf.writestr("ANEXO_RH_02_PLANTILLA_PERSONAL.xlsx", excel_rh_bytes)
