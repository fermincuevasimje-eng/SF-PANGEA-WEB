...
# --- 5. CUERPO LÓGICO ---
    ...
    with tab_j:
            ...
            with c_preview:
                ...
                # Reglas de marcado e iluminación gris para la vista digital en tiempo real
                ...
                if motor_pdf_listo:
                    ...
                    # Cuadrantes F. Registro y Acción (Ambas opciones impresas)
                    pdf_j.set_font("Arial", 'B', 9)
                    x_pos = pdf_j.get_x()
                    y_pos = pdf_j.get_y()
                    
                    # F. Registro Box (Muestra ambas opciones tachando la elegida)
                    ...
                    # Acción Box (Muestra ambas opciones tachando la elegida)
                    ...
                    # Bloque Datos del Empleado e Incidencia
                    pdf_j.set_font("Arial", 'B', 10)
                    ...
                    # Las 4 Firmas Estructuradas Rigurosas
                    pdf_j.set_y(-60)
                    y_firmas = pdf_j.get_y()
                    pdf_j.set_font("Arial", 'B', 8)
                    
                    # Línea 1: Solicitante y Vo. Bo. Director
                    ...
                    # Línea 2: Revisa (Delegada) y Recibe (RH)
