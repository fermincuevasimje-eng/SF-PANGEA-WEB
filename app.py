...
st.set_page_config(page_title="SF PANGEA v4.6.2", layout="wide")

# URL Confirmada y Parámetros
        ...
        if up:
            try:
                ...
                if not df_v.empty:
                    ...
                    st.success(f"✅ Procesados {len(df_f)} puntos con éxito.")
                    ...
                    # KML CON DESGLOSE COMPLETO (Recuperado)
                    kml = simplekml.Kml()
                    ...
                    for p in ordenados:
                        ...
                        # Restauramos todas las columnas originales en el globo
